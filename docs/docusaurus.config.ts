...
const config: Config = {
  title: 'Siren',
  tagline: 'Mermaid graphs done fabulous',
  ...
  organizationName: 'Freymaurer', // Usually your GitHub org/user name.
  projectName: 'Siren', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Freymaurer/Siren',
          label: 'GitHub',
          position: 'right',
        },
      ],
