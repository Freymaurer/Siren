...
using formatting = Siren.formatting;

using direction = Siren.direction;

using notePosition = Siren.notePosition;
...
public class Testing
{
    public void Test1()
    {
        FlowchartElement TestInner = flowchart.raw("test");
        FlowchartElement TestInner2 = flowchart.node("Test");
        FlowchartElement TestInner3 = flowchart.node("Test", "MyName");
        Console.WriteLine(TestInner);
    }
}